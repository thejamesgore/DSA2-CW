...
def show_chessboard(moves):
    ...
    print("")
    print("Here is our chessboard in the terminal prior to running our algorithm.")
    print("")
    print("We will use pyplot to visualise the board and moves our knight will take ")
    print("")
    print(chessboard)
    print("")
    print("The 1s represent the white squares and the 0s represent the black squares")
